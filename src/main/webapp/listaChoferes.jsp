                            ...
                            <% for(Chofer c: choferes) {%>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<%=request.getContextPath()%>/choferes/detalle?id=<%=c.getId()%>" class="btn btn-success">
                                    ...
                                    <td>
                                        ...
                                        <a href="<%=request.getContextPath()%>/choferes/editar?id=<%=c.getId()%>" class="btn btn-primary">
                                    ...
                                    <td>
                                        ...
                                        <a href="<%=request.getContextPath()%>/choferes/eliminar?id=<%=c.getId()%>" class="btn btn-danger">
