            ...
            <div class="col-12">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong>Apellido Paterno: </strong> <%=chofer.getApPaterno() %> </li>
                        <li class="list-group-item"><strong>Apellido Materno: </strong> <%=chofer.getApMaterno() %> </li>
