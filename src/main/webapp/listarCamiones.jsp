                                  ...
                                  <% for(Camion c: camiones) {%>
                                      <tr>
                                          ...
                                          <td>
                                              ...
                                              <a href="<%=request.getContextPath()%>/camiones/detalle?id=<%=c.getId()%>" class="btn btn-success">
                                          ...
                                          <td>
                                              ...
                                              <a href="<%=request.getContextPath()%>/camiones/editar?id=<%=c.getId()%>" class="btn btn-primary">
                                          ...
                                          <td>
                                              ...
                                              <a href="<%=request.getContextPath()%>/camiones/eliminar?id=<%=c.getId()%>" class="btn btn-danger">
